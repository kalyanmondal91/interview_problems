...
system: tictactoe
description: "LLD of Tic Tac Toe Game"
files:
  - "AIPlayer.java"
  - "Board.java"
  - "Cell.java"
...
<button class="tab-btn active" data-tab="AIPlayer.java">AIPlayer.java</button>
...
<button class="tab-btn" data-tab="HumanPlayer.java">HumanPlayer.java</button>
<button class="tab-btn" data-tab="Main.java">Main.java</button>
<button class="tab-btn" data-tab="Mark.java">Mark.java</button>
<button class="tab-btn" data-tab="Player.java">Player.java</button>
<button class="tab-btn" data-tab="StandardWinStrategy.java">StandardWinStrategy.java</button>
<button class="tab-btn" data-tab="TicTacToeGame.java">TicTacToeGame.java</button>
<button class="tab-btn" data-tab="WinStrategy.java">WinStrategy.java</button>
</div>
<div class="tab-content active" id="AIPlayer-java">
<pre><code class="language-java">package org.interview.system_design.lld.tictactoe;
...
<div class="tab-content" id="HumanPlayer-java">
<pre><code class="language-java">package org.interview.system_design.lld.tictactoe;
...
<div class="tab-content" id="Mark-java">
<pre><code class="language-java">package org.interview.system_design.lld.tictactoe;
...
<div class="tab-content" id="StandardWinStrategy-java">
<pre><code class="language-java">package org.interview.system_design.lld.tictactoe;
...
<div class="tab-content" id="TicTacToeGame-java">
<pre><code class="language-java">package org.interview.system_design.lld.tictactoe;
...
<div class="tab-content" id="WinStrategy-java">
<pre><code class="language-java">package org.interview.system_design.lld.tictactoe;
