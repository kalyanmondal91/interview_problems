...
<button class="tab-btn active" data-tab="Balance.java">Balance.java</button>
<button class="tab-btn" data-tab="EqualSplitStrategy.java">EqualSplitStrategy.java</button>
<button class="tab-btn" data-tab="ExactSplitStrategy.java">ExactSplitStrategy.java</button>
<button class="tab-btn" data-tab="Expense.java">Expense.java</button>
<button class="tab-btn" data-tab="ExpenseObserver.java">ExpenseObserver.java</button>
<button class="tab-btn" data-tab="Group.java">Group.java</button>
<button class="tab-btn" data-tab="Main.java">Main.java</button>
<button class="tab-btn" data-tab="PercentageSplitStrategy.java">PercentageSplitStrategy.java</button>
<button class="tab-btn" data-tab="SharesSplitStrategy.java">SharesSplitStrategy.java</button>
<button class="tab-btn" data-tab="Split.java">Split.java</button>
<button class="tab-btn" data-tab="SplitStrategy.java">SplitStrategy.java</button>
<button class="tab-btn" data-tab="SplitType.java">SplitType.java</button>
<button class="tab-btn" data-tab="SplitwiseService.java">SplitwiseService.java</button>
<button class="tab-btn" data-tab="User.java">User.java</button>
</div>
<div class="tab-content active" id="Balance-java">
<pre><code class="language-java">package org.interview.system_design.lld.splitwise;
...
<div class="tab-content" id="EqualSplitStrategy-java">
<pre><code class="language-java">package org.interview.system_design.lld.splitwise;
...
<div class="tab-content" id="ExactSplitStrategy-java">
<pre><code class="language-java">package org.interview.system_design.lld.splitwise;
...
<div class="tab-content" id="Expense-java">
<pre><code class="language-java">package org.interview.system_design.lld.splitwise;
...
<div class="tab-content" id="ExpenseObserver-java">
<pre><code class="language-java">package org.interview.system_design.lld.splitwise;
...
<div class="tab-content" id="Group-java">
<pre><code class="language-java">package org.interview.system_design.lld.splitwise;
...
<div class="tab-content" id="PercentageSplitStrategy-java">
<pre><code class="language-java">package org.interview.system_design.lld.splitwise;
...
<div class="tab-content" id="SharesSplitStrategy-java">
<pre><code class="language-java">package org.interview.system_design.lld.splitwise;
...
<div class="tab-content" id="Split-java">
<pre><code class="language-java">package org.interview.system_design.lld.splitwise;
...
<div class="tab-content" id="SplitStrategy-java">
<pre><code class="language-java">package org.interview.system_design.lld.splitwise;
...
<div class="tab-content" id="SplitType-java">
<pre><code class="language-java">package org.interview.system_design.lld.splitwise;
...
<div class="tab-content" id="SplitwiseService-java">
<pre><code class="language-java">package org.interview.system_design.lld.splitwise;
