...
system: moviebooking
description: "LLD of Movie Booking System"
files:
  - "Booking.java"
...
<button class="tab-btn active" data-tab="Booking.java">Booking.java</button>
<button class="tab-btn" data-tab="BookingObserver.java">BookingObserver.java</button>
<button class="tab-btn" data-tab="BookingStatus.java">BookingStatus.java</button>
<button class="tab-btn" data-tab="Main.java">Main.java</button>
<button class="tab-btn" data-tab="Movie.java">Movie.java</button>
<button class="tab-btn" data-tab="MovieBookingService.java">MovieBookingService.java</button>
<button class="tab-btn" data-tab="Payment.java">Payment.java</button>
...
<button class="tab-btn" data-tab="Screen.java">Screen.java</button>
<button class="tab-btn" data-tab="Seat.java">Seat.java</button>
<button class="tab-btn" data-tab="SeatStatus.java">SeatStatus.java</button>
<button class="tab-btn" data-tab="SeatType.java">SeatType.java</button>
<button class="tab-btn" data-tab="Show.java">Show.java</button>
<button class="tab-btn" data-tab="StandardPricingStrategy.java">StandardPricingStrategy.java</button>
<button class="tab-btn" data-tab="Theatre.java">Theatre.java</button>
</div>
<div class="tab-content active" id="Booking-java">
<pre><code class="language-java">package org.interview.system_design.lld.moviebooking;
...
<div class="tab-content" id="BookingObserver-java">
<pre><code class="language-java">package org.interview.system_design.lld.moviebooking;
...
<div class="tab-content" id="BookingStatus-java">
<pre><code class="language-java">package org.interview.system_design.lld.moviebooking;
...
<div class="tab-content" id="Movie-java">
<pre><code class="language-java">package org.interview.system_design.lld.moviebooking;
...
<div class="tab-content" id="MovieBookingService-java">
<pre><code class="language-java">package org.interview.system_design.lld.moviebooking;
...
<div class="tab-content" id="Payment-java">
<pre><code class="language-java">package org.interview.system_design.lld.moviebooking;
...
<div class="tab-content" id="Screen-java">
<pre><code class="language-java">package org.interview.system_design.lld.moviebooking;
...
<div class="tab-content" id="Seat-java">
<pre><code class="language-java">package org.interview.system_design.lld.moviebooking;
...
<div class="tab-content" id="SeatStatus-java">
<pre><code class="language-java">package org.interview.system_design.lld.moviebooking;
...
<div class="tab-content" id="SeatType-java">
<pre><code class="language-java">package org.interview.system_design.lld.moviebooking;

/**
 * Enum representing types of cinema seats.
 */
...
<div class="tab-content" id="Show-java">
<pre><code class="language-java">package org.interview.system_design.lld.moviebooking;
...
<div class="tab-content" id="StandardPricingStrategy-java">
<pre><code class="language-java">package org.interview.system_design.lld.moviebooking;
...
<div class="tab-content" id="Theatre-java">
<pre><code class="language-java">package org.interview.system_design.lld.moviebooking;
