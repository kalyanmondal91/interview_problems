...
| Participant | Role |
|-------------|------|
| **Abstraction** | High-level layer; holds reference to Implementor |
...
- More complex when there is only one implementation
- Harder to understand the split between abstraction and implementor

## Real-World Examples

- `Java AWT: Window + Peer`
