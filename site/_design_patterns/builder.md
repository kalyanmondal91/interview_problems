...
| **Builder** | Declares steps to build product parts |
| **ConcreteBuilder** | Implements building steps |
| **Director (optional)** | Orchestrates builder calls in order |

## Pros

- Construct objects step-by-step
- Reuse same construction for different representations
- Immutable products
...
- Classic GoF: Director + Builder
- Fluent Builder (most common in Java)
