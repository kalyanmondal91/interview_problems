...
| Participant | Role |
|-------------|------|
| **Context** | Maintains a reference to the current State; delegates behavior |
| **State** | Declares methods for each state-dependent behavior |
...
- State transitions can become complex to track

## Real-World Examples

- `Order lifecycle: Pending to Shipped to Delivered`
- `Traffic lights: Red to Green to Yellow`
- `Vending machine: Idle to HasCoin to Dispensing`
- `TCP connection states`

## Variants

- State transitions owned by Context
- State transitions owned by ConcreteState
