...
intent: "Without violating encapsulation, capture and externalize an objects internal state so that it can be restored later."
...
Without violating encapsulation, capture and externalize an objects internal state so that it can be restored later.
